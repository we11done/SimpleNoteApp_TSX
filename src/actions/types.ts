...
export const FETCH_DELETED_MEMO_LIST_REQUEST =
  'FETCH_DELETED_MEMO_LIST_REQUEST';
export const FETCH_DELETED_MEMO_LIST_SUCCESS =
  'FETCH_DELETED_MEMO_LIST_SUCCESS';
export const FETCH_DELETED_MEMO_LIST_FAILURE =
  'FETCH_DELETED_MEMO_LIST_FAILURE';
...
export const ADD_MEMO_SUCESSS = 'ADD_MEMO_SUCESSS';
